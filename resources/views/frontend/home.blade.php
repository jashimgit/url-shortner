...
<body>
	...
	<footer id="footer">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2022 FDLock BD. All rights reserved.</p>
					<p class="pull-right">Developed by <span><a target="_blank"
								href="#">Jashim Uddin</a></span></p>
				</div>
			</div>
		</div>
